...
import static com.android.base.Config.WALLET_NETWORK_TEST;
...
public final class Constants {
    ...
    public static final NetworkParameters NETWORK_PARAMETERS =WALLET_NETWORK_TEST? TestNet3Params.get() : MainNetParams.get();
...
//    /** URL to fetch dynamic fees from. */
    ...
    public static final int ADDRESS_FORMAT_GROUP_SIZE = 4;//4： 4位一分割类似与银行卡号格式
