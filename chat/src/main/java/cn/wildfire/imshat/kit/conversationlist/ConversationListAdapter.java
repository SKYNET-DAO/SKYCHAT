...
import cn.wildfire.imshat.kit.conversationlist.viewholder.ConversationViewHolder;
import cn.wildfire.imshat.kit.conversationlist.viewholder.ConversationViewHolderManager;
import cn.wildfire.imshat.kit.conversationlist.viewholder.StatusNotificationContainerViewHolder;
                        ...
                        try {
                            ...
                            if (menuItem.contextMenuItem.confirm()) {
                                ...
                                if (menuItem.contextMenuItem.confirmPromptResId() != 0) {
                                    content = UIUtils.getString(menuItem.contextMenuItem.confirmPromptResId());
                                } else {
