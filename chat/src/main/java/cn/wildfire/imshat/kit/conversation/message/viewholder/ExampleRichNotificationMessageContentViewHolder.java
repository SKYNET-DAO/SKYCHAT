...
public class ExampleRichNotificationMessageContentViewHolder extends NotificationMessageContentViewHolder {
    ...
    ImageView imageView;
    private final String transform=UIUtils.getString(R.string.str_transform);
    ...
    @MessageContextMenuItem(tag = MessageContextMenuItemTags.TAG_FORWARD, titleResId =R.string.str_recell,title = "", priority = 11)
