package cn.wildfire.imshat.kit.search.module;
...
import cn.wildfire.imshat.kit.search.viewHolder.ConversationViewHolder;
...
public class ConversationSearchModule extends SearchableModule<ConversationSearchResult, ConversationViewHolder> {
    ...
    public String category() {
        return UIUtils.getString(R.string.str_chat_history);
    }
