...
import cn.wildfire.imshat.kit.audio.AudioRecorderPanel;
import cn.wildfire.imshat.kit.conversation.ext.core.ConversationExtension;
import cn.wildfire.imshat.kit.conversation.mention.MentionGroupMemberActivity;
...
import cn.wildfire.imshat.kit.widget.KeyboardHeightFrameLayout;
...
import static cn.wildfire.imshat.kit.conversation.ConversationActivity.REQUEST_PICK_MENTION_CONTACT;
...
public class ConversationInputPanel extends FrameLayout implements IEmotionSelectedListener {
    ...
    void onExtImageViewClick() {
        ...
        if (audioButton.getVisibility() == VISIBLE&&audioRecorderPanel.isRecording) {
            return;
        }
