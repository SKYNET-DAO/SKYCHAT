...
public class LoginActivity extends WfcBaseActivity {
    ...
    void login() {
        ...
        String url = "http://" + Config.Companion.getAPP_SERVER_HOST() + ":" + Config.Companion.getAPP_SERVER_PORT() + "/api/login";
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(LoginActivity.this, "Network fault。。。", Toast.LENGTH_SHORT).show();
            return;
        }
