...
public class StickerMessageContent extends MediaMessageContent {
    ...
    public MessagePayload encode() {
        ...
        payload.searchableContent = "["+ BaseApp.getContext().getString(com.android.base.R.string.str_gif_emoj) +"]";
    ...
    public String digest(Message message) {
        return "["+BaseApp.getContext().getString(com.android.base.R.string.str_gif_emoj)+"]";
    }
