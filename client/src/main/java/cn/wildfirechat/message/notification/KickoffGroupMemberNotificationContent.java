...
public class KickoffGroupMemberNotificationContent extends GroupNotificationMessageContent {
    ...
    public String formatNotification(Message message) {
        ...
        if (fromSelf) {
            sb.append(BaseApp.getContext().getString(R.string.str_nin_action));
        } else {
            sb.append(ChatManager.Instance().getGroupMemberDisplayName(groupId, operator));
            sb.append(BaseApp.getContext().getString(R.string.str_ba));
        }
        ...
        sb.append(" "+BaseApp.getContext().getString(R.string.str_ba_remove));
        return sb.toString();
    }
