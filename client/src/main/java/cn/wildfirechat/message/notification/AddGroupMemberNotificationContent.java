...
public class AddGroupMemberNotificationContent extends GroupNotificationMessageContent {
    ...
    public String formatNotification(Message message) {
        ...
        if (fromSelf) {
            sb.append(BaseApp.getContext().getString(R.string.str_invite_i));
        } else {
            sb.append(ChatManager.Instance().getGroupMemberDisplayName(groupId, invitor));
            sb.append(BaseApp.getContext().getString(R.string.str_invite));
        }
        ...
        sb.append(BaseApp.getContext().getString(R.string.str_join_group));
        return sb.toString();
    }
